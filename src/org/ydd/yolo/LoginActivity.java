...
public class LoginActivity extends Activity {
	 ...
	 */
	private PostRequest mAuthTask = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mNumber = getIntent().getStringExtra(EXTRA_EMAIL);
	...
	public void attemptLogin() {
		...
		if (cancel) {
			...
			showProgress(true);
			Log.d("TAAAAAAAG", "ALALALALALAL");
			JSONObject data = new JSONObject();
			try {
				data.put("number", mNumber);
				data.put("password", mPassword);
				Log.d("TAAAAG", "LOLOLOLOLOL");
				mAuthTask = new PostRequest();
				mAuthTask.jsonbody = data.toString();
				mAuthTask.postexecute = new PostExecute() {
					
					@Override
					public void doAfter(String string) throws JSONException {
						Log.d("DATA", "THIS DATA LA "+string);
						...
						if(message.equals("Login successful")) {
							...
							pref.set("number", mNumber);
							pref.set("password", mPassword);
							startActivity(new Intent(getApplicationContext(), UserSplash.class));
							finish();
						}
						
					}
				};
				Log.d("LINK LOGIN", Constants.server+"/login");
				mAuthTask.execute(Constants.server+"/login");
